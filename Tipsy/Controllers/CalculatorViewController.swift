...
class CalculatorViewController: UIViewController {
    ...
    @IBAction func calculatePressed(_ sender: UIButton) {
        ...
        if bill != "" {
            ...
            //Turn the bill from a String e.g. "123.50" to an actual String with decimaplaces.
            //e.g. 125.50
            billTotal = Double(bill)!
            
            //Multiply the bill by the tip percentage and divide by the number of people tsplit the bill.
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "goToResult" {
            ...
            destinationViewController.tip = Int(tipPercentage * 100)
            destinationViewController.split = self.numberOfPeople
        }
    }
